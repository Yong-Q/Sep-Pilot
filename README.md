...
[![Release](https://img.shields.io/badge/release-v3.4.65-6C63FF?style=for-the-badge)](https://github.com/Yong-Q/Sep-Pilot/tree/release/v3.4.65)
...
Release `v3.4.65` passed 514 backend tests, frontend tests and production build validation, registered-tool smoke checks, and a sanitized-export privacy scan.
